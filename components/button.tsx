    ...
    <TouchableOpacity
      className={cn(
        "flex-row items-center justify-center gap-2 rounded-full px-4 py-2.5",
        {
          ...
          "bg-zinc-100 active:bg-zinc-200 dark:bg-zinc-900 dark:active:bg-zinc-800": variant === "secondary",
          "border border-primary bg-primary/10 active:bg-primary/20": variant === "outline",
      ...
      {children || (
        <Text
          className={cn("text-center font-medium", {
            ...
            "text-black dark:text-white": variant === "secondary" || variant === "ghost",
